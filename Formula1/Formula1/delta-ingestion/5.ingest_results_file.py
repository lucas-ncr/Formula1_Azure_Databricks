...
# results_final_df.write.mode("append").format("delta").partitionBy("race_id").saveAsTable("f1_processed.results")
...
write_df = rearrange_partition_column(results_final_df, "result_id")
