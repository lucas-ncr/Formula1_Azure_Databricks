...
dbutils.fs.mount(
  source = "abfss://demo@formula1dl72.dfs.core.windows.net/",
  mount_point = "/mnt/formula1dl72/demo",
  extra_configs = configs)

# COMMAND ----------

display(dbutils.fs.ls("/mnt/formula1dl72/demo"))

# COMMAND ----------

display(spark.read.csv("/mnt/formula1dl72/demo/circuits.csv", header = True))
...
dbutils.fs.unmount("/mnt/formula1dl72/demo")